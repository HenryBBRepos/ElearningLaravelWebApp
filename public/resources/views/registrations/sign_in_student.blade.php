                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="input-box">
                                                ...
                                                <div class="form-group">
                                                    <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current_password" placeholder="Password">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <div class="custom-checkbox d-flex justify-content-between">
                                                    ...
                                                    <a href="/forget_password" class="primary-color-2"> Forgot my password?</a>
                                                </div>
                                            </div>
                                        </div><!-- end col-md-12 -->
                                        <div class="col-lg-12 ">
                                        ...
                                        <div class="col-lg-12">
                                            <p class="mt-4">Don't have an account? <a href="{{url('sign_up_student')}}" class="primary-color-2">Sign up</a></p>
                                        </div><!-- end col-md-12 -->
                                    </div><!-- end row -->
                                </form>
