...
{{--                        </div>--}}
                        <div class="section-heading">
                            <h2 class="section__title font-size-20 pb-1">Become a Learner, and access all our subject topics for all SHS student</h2>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 ">
                                            <div class="input-box">
                                                ...
                                                <div class="form-group">
                                                    <input class="form-control @error('first_name') is-invalid @enderror" type="text" name="first_name" value="{{ old('first_name') }}" required autocomplete="last_name" autofocus  placeholder="First name">
                                        ...
                                        <div class="col-lg-12 ">
                                            <div class="input-box">
                                                ...
                                                <div class="form-group">
                                                    <input class="form-control @error('last_name') is-invalid @enderror" type="text" name="last_name" value="{{ old('last_name') }}" required autocomplete="last_name" autofocus placeholder="Last name">
                                                    <span class="la la-user input-icon"></span>
                                                    @error('last_name')
                                                    <span role="alert">
                                                            <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-lg-12 ">
                                            <div class="input-box">
                                                <label class="label-text">School Name<span class="primary-color-2 ml-1">*</span></label>
                                                <div class="form-group">
                                                    <input class="form-control @error('school_name') is-invalid @enderror" name="school_name" value="{{ old('school_name') }}" type="text" placeholder="Enter school name" required autocomplete="school_name">
                                                    <span class="la la-user input-icon"></span>
                                                    @error('school_name')
                                                    <span role="alert">
                                                            <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-lg-12 ">
                                            <div class="input-box">
                                                <label class="label-text">Class<span class="primary-color-2 ml-1">*</span></label>
                                                <div class="form-group">
                                                    <div class="">
                                                        <div class="sort-ordering user-form-short">
                                                            <select class="sort-ordering-select @error('class') is-invalid @enderror" name="class" value="{{ old('class') }}" required autocomplete="class">
                                                                <option value="0" selected="">Choose your class</option>

                                                                <option value="JHS 1">SHS 1</option>
                                                                <option value="JHS 2">SHS 2</option>
                                                                <option value="JHS 3">SHS 3</option>
                                                            </select>
                                                            @error('class')
                                                                <span role="alert">
                                                                    <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-lg-12 ">
                                            <div class="input-box">
                                                ...
                                                <div class="form-group">
                                                    <div class="">
                                                        <div class="sort-ordering user-form-short">
                                                            <select class="sort-ordering-select @error('country') is-invalid @enderror" name="country" value="{{ old('country') }}" required autocomplete="country">
                                                                <option value="0" selected="">Select Country</option>
                                                                <option value="Ghana">Ghana</option>
                                                                <option value="Nigeria">Nigeria</option>
                                                                <option value="Togo">Togo</option>
                                                                <option value="Seirre Leone">Seirre Leone</option>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="input-box">
                                                ...
                                                <div class="form-group">
                                                    <input class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" type="text" placeholder="Enter email address" required autocomplete="email">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="input-box">
                                                ...
                                                <div class="form-group">
                                                    <input class="form-control @error('password') is-invalid @enderror" name="password" value="{{ old('password') }}" type="password" placeholder="Enter password" required autocomplete="password">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="input-box">
                                                ...
                                                <div class="form-group">
                                                    <input class="form-control" type="password" name="password_confirmation" placeholder="Confirm password" required autocomplete="new_password">
                                                    <span class="la la-lock input-icon"></span>
                                                </div>
                                            </div>
                                        </div><!-- end col-md-12 -->
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <div class="custom-checkbox">
                                                    ...
                                                    <label for="chb1"><span class="line-height-24 d-block">Yes! I want to get the most out of Wolo by receiving
                                                           treated courses based on my class</span></label>
                                                </div>
                                                <div class="custom-checkbox">
                                        ...
                                        <div class="col-lg-12">
                                            <p class="mt-4">Already have an account? <a href="{{url('sign_in_student')}}" class="primary-color-2">Log in</a></p>
                                        </div><!-- end col-md-12 -->
                                    </div><!-- end row -->
                                </form>
