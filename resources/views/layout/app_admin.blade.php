...
<head>
    ...
    <link rel="stylesheet" href="asset_home/css/select2.min.css">
        ...
        <div class="dashboard-nav-container">
            ...
            <div class="side-menu-wrap">
                <ul class="side-menu-ul">
                    ...
                    <li class="sidenav__item page-active"><a href="dashboard-courses.html"><i class="la la-bars"></i>Courses</a></li>
                    <li class="sidenav__item"><a href="dashboard-profile.html"><i class="la la-pencil"></i>Enroll Course</a></li>
                    <li class="sidenav__item"><a href="dashboard-courses.html"><i class="la la-file-video-o"></i>Subscription</a></li>
...
<script src="asset_home/js/select2.min.js"></script>
