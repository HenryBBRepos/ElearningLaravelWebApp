        ...
        <div class="container-fluid">
            <div class="main-menu-content">
                <div class="row align-items-center">
                    <div class="col-lg-2">
                        <div class="logo-box">
                            <a href="{{url('index')}}" class="logo"><img src="asset_home/images/logo.png" alt="logo"></a>
                            ...
                            <div class="logo-right-button d-flex align-items-center">
                                <div class="shop-cart course-cart h-auto">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="#" class="shop-cart-btn font-size-15 text-uppercase">Preparation</a>
                ...
                <div class="my-courses-tab">
                    <div class="section-tab section-tab-2">
                        <ul class="nav nav-tabs" role="tablist" id="review">
                            <li role="presentation">
                                <a href="#subject" role="tab" data-toggle="tab" class="active" aria-selected="true">
                                    <i class="la la-book"></i>My Subjects
                                </a>
                            </li>
                            <li role="presentation">
                                <a href="#topic" role="tab" data-toggle="tab" aria-selected="false">
                                    <i class="la la-file-video-o"></i>Topics
                                </a>
                            </li>
                            <li role="presentation">
                                <a href="#learning_path" role="tab" data-toggle="tab" aria-selected="false">
                                    <i class="la la-arrow-circle-o-right"></i>Learning Path
                                </a>
                            </li>

                            <li role="presentation">
                                <a href="#exercise" role="tab" data-toggle="tab" aria-selected="false">
                                    <i class="la la-question"></i>Exercise
                                </a>
                            </li>
                            <li role="presentation">
                                <a href="#quiz" role="tab" data-toggle="tab" aria-selected="false">
                                    <i class="la la-question"></i>Quiz
                                </a>
                            </li>
                            <li role="presentation">
                                <a href="#exam" role="tab" data-toggle="tab" aria-selected="false">
                                    <i class="la la-question"></i>Exam
                                </a>
                            </li>

                            <li role="presentation">
                                <a href="#library" role="tab" data-toggle="tab" aria-selected="false">
                                    <i class="la la-building-o"></i>My Library
                                </a>
                            </li>

                            <li role="presentation">
                                <a href="#teacher" role="tab" data-toggle="tab" aria-selected="false">
                                    <i class="la la-users"></i>My Teachers
                                </a>
                            </li>
